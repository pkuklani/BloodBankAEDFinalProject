...
public class DeliveryWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DeliveryWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, UserAccount account1, Organization organization, Business business) {
        initComponents();
...
//yourFile.createNewFile(); // if file already exists will do nothing 
            ...
            for (WorkRequest request : userAccount1.getWorkQueue().getWorkRequestList()) {
                ...
                if (i == 0) {//ObjectOutputStream oos = null;
    ...
    private void initComponents() {
        ...
        tblWorkRequests.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Order ID", "Restaurant", "Message", "Order By", "Status", "Delivery Date"
            }
        ) {
        ...
        if (tblWorkRequests.getColumnModel().getColumnCount() > 0) {
            ...
            tblWorkRequests.getColumnModel().getColumn(2).setPreferredWidth(0);

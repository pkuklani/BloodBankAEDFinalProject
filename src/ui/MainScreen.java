...
public class MainScreen extends javax.swing.JPanel {
     ...
     */
    public MainScreen(JPanel mainWorkArea, UserAccount userAccount,UserAccount userAccount1, Organization organization, Business business){
        initComponents();
       ...
       // System.out.println("main account "+userAccount+"account1 "+userAccount1);
        initUserWorkArea();
    }
    ...
    private void initUserWorkArea() {
        ...
        workArea.add("workArea", userAccount.getRole().createWorkArea(workArea, userAccount,userAccount1, organization, business));
